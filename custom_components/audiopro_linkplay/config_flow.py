"""Config flow for Audio Pro (LinkPlay)."""
...
class AudioProLinkPlayFlowHandler(ConfigFlow, domain=DOMAIN):
    """Handle an Audio Pro (LinkPlay) config flow.
    ...
    def async_get_options_flow(
        ...
        return AudioProLinkPlayOptionsFlowHandler()
