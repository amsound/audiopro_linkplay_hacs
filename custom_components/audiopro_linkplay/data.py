...
class AudioProLinkPlayData:
    ...
    async def async_cleanup_event_notifiers(self, event: Event) -> None:
        ...
        LOGGER.debug("Cleaning resources in AudioProLinkPlayData")
...
def get_domain_data(hass: HomeAssistant) -> AudioProLinkPlayData:
    """Obtain this integration's domain data, creating it if needed."""
    if DOMAIN in hass.data:
        return cast(AudioProLinkPlayData, hass.data[DOMAIN])

    data = AudioProLinkPlayData(hass)
